...
<head>
    ...
    <title>Gestion des prospects - Khallasli CRM</title>
            ...
            <div class="content">
                <div class="container">
                    <div class="page-title">
                        <h3>Prospects
                            <a href="add_prospect.php" class="btn btn-sm btn-outline-secondary float-end"><i class="fas fa-plus"></i> Ajouter Prospect</a>
                        </h3>
                    </div>
                                    ...
                                    try {
                                        ...
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            echo "<tr>
                                                    ...
                                                    <td>{$row['status']}</td>
                                                    <td class='text-end'>
                                                        <a href='edit_prospect.php?id={$row['id']}' class='btn btn-outline-primary btn-rounded'><i class='fas fa-pen'></i></a>
                                                        <a href='delete_prospect.php?id={$row['id']}' class='btn btn-outline-danger btn-rounded'><i class='fas fa-trash'></i></a>
                                                    </td>
                                                </tr>";
                                        }
                                    } catch (PDOException $e) {
