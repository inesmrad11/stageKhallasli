            ...
            <ul class="list-unstyled components text-secondary">
                ...
                <li>
                    ...
                    <ul class="collapse list-unstyled" id="pagesmenu">
                        ...
                        <li>
                            <a href="404.html"><i class="fas fa-primary-circle"></i>404 Error page</a>
                        </li>
                        <li>
                            <a href="500.html"><i class="fas fa-primary-circle"></i>500 Error page</a>
                        </li>
                    </ul>
                </li>
                <li>
            ...
            <div class="content">
                <div class="container">
                    <div class="page-title">
                        <h3>User Roles
                            <a href="roles.html" class="btn btn-sm btn-outline-secondary float-end"><i class="fas fa-plus-circle"></i> Add</a>
                            <a href="users.html" class="btn btn-sm btn-outline-secondary float-end me-1"><i class="fas fa-angle-left"></i> <span class="btn-header">Return</span></a>
                        </h3>
                    </div>
