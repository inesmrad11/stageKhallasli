...
<head>
    ...
    <title>Gestion des Points de Vente - Khallasli CRM</title>
            ...
            <div class="content">
                <div class="container">
                    <div class="page-title">
                        <h3>Points de Vente
                            <a href="add_PDV.php" class="btn btn-sm btn-outline-secondary float-end"><i class="fas fa-plus"></i> Ajouter Point de Vente</a>
                        </h3>
                    </div>
                        ...
                        <div class="box-body">
                            <table width="100%" class="table table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php
                                    try {
                                        $stmt = $pdo->query("SELECT * FROM points_de_vente");
                                        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                                            echo "<tr>
                                                    ...
                                                    <td class='text-end'>
                                                        <a href='edit_PDV.php?id={$row['id']}' class='btn btn-outline-primary btn-rounded'><i class='fas fa-pen'></i></a>
                                                        <a href='delete_PDV.php?id={$row['id']}' class='btn btn-outline-danger btn-rounded'><i class='fas fa-trash'></i></a>
                                                    </td>
                                                </tr>";
                                        }
                                    } catch (PDOException $e) {
